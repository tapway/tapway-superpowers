...
name: observe
description: >-
  Structured logging, RED metrics, OTel, alerting (Hermes port of tapway-superpowers observe skill).
version: 1.2.0
...
3. **Severity** — SEV1–4 per the `incident-runbook` skill: `SEV1`/`SEV2` = page (wake someone now), `SEV3`/`SEV4` = ticket (fix next business day)

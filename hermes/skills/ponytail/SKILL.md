...
metadata:
  hermes:
    tags: ["ponytail", "yagni", "simplicity", "minimalism", "dependencies"]
    related_skills: [ponytail-review, ponytail-audit, ponytail-debt, ponytail-gain, ponytail-help]
---
...
- **Auto-triggering:** Hermes surfaces skills by description match, so this rule
  ...
  preload it explicitly: `hermes -s ponytail ...` (Hermes Agent: `--skills ponytail`).

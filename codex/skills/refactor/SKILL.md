...
**Provide it separately:** it's an optional third-party skill, not part of this superpowers set — add it to your skills environment on its own (it's not installed by `codex/install.sh`). Check the skills directory for the exact name.

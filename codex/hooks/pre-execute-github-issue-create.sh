...
#
# Codex sends the Bash payload as JSON on stdin; an optional plan-file path can
# be passed as an argument after the (ignored) tool-input command.
#
# Usage (invoked by the $writing-plans skill / $tapway pipeline):
#   pre-execute-github-issue-create.sh [plan-file]

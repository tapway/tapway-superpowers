...
metadata:
  hermes:
    tags: ["ponytail", "benchmark", "impact"]
    related_skills: [ponytail, ponytail-review, ponytail-audit, ponytail-debt, ponytail-help]
---
...
- **Auto-triggering:** Hermes surfaces skills by description match, so this rule
  ...
  preload it explicitly: `hermes -s ponytail-gain ...` (Hermes Agent: `--skills ponytail-gain`).

...
> **Running-environment check:** You can launch the actual app and observe its
> behavior in a browser or terminal — this can replace or supplement this skill
> when you need to confirm the golden path works end-to-end in a running
> environment, not just via tests.
...
- [ ] For sensitive changes: run `$security-audit` on the diff before marking done
